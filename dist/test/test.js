...
describe('index.random', function () {
    it('should exist', function () {
        chai_1.expect(index_1.random).to.exist;
    });
    it('should be a function', function () {
...
describe('index.random', function () {
    ...
    it('should return a 0-length string', function () {
        chai_1.expect(index_1.random(0).length <= 0).to.be.true;
    });
    it('should return a 1-length string', function () {
        chai_1.expect(index_1.random(1).length <= 1).to.be.true;
    });
    it('should return a 2-length string', function () {
        chai_1.expect(index_1.random(2).length <= 2).to.be.true;
    });
    it('should return a 3-length string', function () {
        chai_1.expect(index_1.random(3).length <= 3).to.be.true;
    });
    it('should return a 4-length string', function () {
        chai_1.expect(index_1.random(4).length <= 4).to.be.true;
    });
    it('should return a 8-length string', function () {
        chai_1.expect(index_1.random(8).length <= 8).to.be.true;
    });
...
describe('index.random', function () {
    ...
    it('should return a 2-range string', function () {
        chai_1.expect(index_1.random(8, 2).length <= 8).to.be.true;
    });
    it('should return a 3-range string', function () {
        chai_1.expect(index_1.random(8, 3).length <= 8).to.be.true;
    });
    it('should return a 4-range string', function () {
        chai_1.expect(index_1.random(8, 4).length <= 8).to.be.true;
    });
    it('should return a 8-range string', function () {
        chai_1.expect(index_1.random(8, 8).length <= 8).to.be.true;
    });
    it('should return a 16-range string', function () {
        chai_1.expect(index_1.random(8, 16).length <= 8).to.be.true;
    });
    it('should return a 32-range string', function () {
        chai_1.expect(index_1.random(8, 32).length <= 8).to.be.true;
    });
    it('should return a 36-range string', function () {
        chai_1.expect(index_1.random(8, 36).length <= 8).to.be.true;
    });
