...
describe('index.random', () => {
    ...
    it('should return a 0-length string', () => {
        expect(random(0).length <= 0).to.be.true;
    });
    it('should return a 1-length string', () => {
        expect(random(1).length <= 1).to.be.true
    });
    it('should return a 2-length string', () => {
        expect(random(2).length <= 2).to.be.true;
    });
    it('should return a 3-length string', () => {
        expect(random(3).length <= 3).to.be.true;
    });
    it('should return a 4-length string', () => {
        expect(random(4).length <= 4).to.be.true;
    });
    it('should return a 8-length string', () => {
        expect(random(8).length <= 8).to.be.true;
    });
...
describe('index.random', () => {
    ...
    it('should return a 2-range string', () => {
        expect(random(8, 2).length <= 8).to.be.true;
    });
    it('should return a 3-range string', () => {
        expect(random(8, 3).length <= 8).to.be.true;
    });
    it('should return a 4-range string', () => {
        expect(random(8, 4).length <= 8).to.be.true;
    });
    it('should return a 8-range string', () => {
        expect(random(8, 8).length <= 8).to.be.true;
    });
    it('should return a 16-range string', () => {
        expect(random(8, 16).length <= 8).to.be.true;
    });
    it('should return a 32-range string', () => {
        expect(random(8, 32).length <= 8).to.be.true;
    });
    it('should return a 36-range string', () => {
        expect(random(8, 36).length <= 8).to.be.true;
    });
